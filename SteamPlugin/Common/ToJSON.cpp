...
std::string ToJSON(LobbyChatUpdate_t value)
{
    return std::string("{"
        "\"SteamIDLobby\": " + std::to_string(GetPluginHandle(value.m_ulSteamIDLobby)) + ", "
		"\"SteamIDUserChanged\": " + std::to_string(GetPluginHandle(value.m_ulSteamIDUserChanged)) + ", "
		"\"SteamIDMakingChange\": " + std::to_string(GetPluginHandle(value.m_ulSteamIDMakingChange)) + ", "
...
std::string ToJSON(LobbyDataUpdate_t value)
{
    return std::string("{"
        "\"SteamIDLobby\": " + std::to_string(GetPluginHandle(value.m_ulSteamIDLobby)) + ", "
		"\"SteamIDMember\": " + std::to_string(GetPluginHandle(value.m_ulSteamIDMember)) + ", "
		"\"Success\": " + std::to_string(value.m_bSuccess) + "}");
}
...
std::string ToJSON(P2PSessionState_t value)
{
    return std::string("{"
		...
		"\"RemoteIP\": \"" + ConvertIPToString(value.m_nRemoteIP) + "\", "
...
std::string ToJSON(RemoteStorageDownloadUGCResult_t value)
{
    return std::string("{"
		...
		"\"SteamIDOwner\": " + std::to_string(GetPluginHandle(value.m_ulSteamIDOwner)) + "}");
}
...
{
    return std::string("{"
        "\"GameAppID\": " + std::to_string(value.m_nGameID.AppID()) + ", "
